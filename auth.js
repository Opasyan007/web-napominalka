...
AuthStateChanged(auth, (user) => { if (statusEl) { statusEl.textContent = user ? Авторизован: ${user.email} : "Не авторизован"; } console.log("[auth] state:", user ? user.email : "no user"); });
